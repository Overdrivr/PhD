...
\newglossaryentry{Zc}
{
  ...
  description={is the ratio of the amplitudes of voltage and current of a
               ...
               that is, a wave traveling in one direction in the absence of
...
\newglossaryentry{vna}
{
  ...
  description={Instrument that measures network parameters of electrical networks.
  They are commonly used to measure S-parameters of two-port networks.
  Compared to an SNA (Scalar Network Analyzer), a VNA is able to measure amplitude
...
\newacronym{hmm}{HMM}{Human Metal Model}
\newacronym{fpga}{FPGA}{Field Programmable Gate Array}
\newacronym{epa}{EPA}{Electrostatic Protected Area}
\newacronym{seed}{SEED}{System Efficient ESD Design}
