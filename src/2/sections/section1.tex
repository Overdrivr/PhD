...
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.7\textwidth]{src/2/figures/tline_comparison.png}
...
Ferrite bead are passive filtering devices, often found in \lgs{ic} decoupling networks.
...
The main coil is represented by an inductance L, a parasitic resistance R\textsubscrip{p} and capacitance C\textsubscript{p} and a series resistance R\textsubscript{s}.
