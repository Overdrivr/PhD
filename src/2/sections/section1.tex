...
\inputminted[frame=single,label={VHDL-AMS transmission line model}]{VHDL}{src/2/snippets/tline.vhdl}
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=0.3\textwidth]{src/2/figures/line_test_setup.pdf}
...
% TODO: Simulation times

%TODO: Etoffer cette validation
