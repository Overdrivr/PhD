...
Specifically, a configurable four-points piecewise linear model is written in Verilog-A.
It is given hereafter for reference.
The model is configured easily with 4 four (V\textsubscript{i},I\textsubscript{i}) coordinates.

\inputminted[frame=single,label={Piecewise-linear 4 points model}]{verilog}{src/4/snippets/pwl_4pts.va}
