...
\begin{figure}[!h]
  \centering
  \includegraphics[width=\textwidth]{src/4/figures/characterization_setup_regu_complete_modified.pdf}
...
\begin{figure}[!h]
  \centering
  \includegraphics[width=\textwidth]{src/4/figures/impact_connection_changed_v2p5.png}
  \caption{Impact of a single connection changed on V\textsubscript{2p5}}
  \label{fig:simu_comparison_v2p5_conn}
\end{figure}

One of the current limitations of the model.
