...
It can deliver a maximum of \SI{20}{\milli\ampere} of current while maintaining \SI{8}{\volt}, corresponding to a minimum output load this block can sustain is \SI{400}{\ohm}.
The bandgap, on the other hand, provides a reference voltage at \SI{1}{\volt} but does not deliver a lot of DC current.
