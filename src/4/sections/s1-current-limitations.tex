...
The new method is applied to the testchip for testing its validity.
The pre-regulator, bandgap and regulator characterizion are given in Figs. \ref{fig:pre-reg-cz-v2},

\begin{figure}[!h]
  \centering
  \includegraphics[width=0.4\textwidth]{src/4/figures/cz_prereg_v2.pdf}
  \caption{Pre-regulator characterization}
  \label{fig:pre-reg-cz-v2}
\end{figure}

\begin{figure}[!h]
  \centering
  \includegraphics[width=0.4\textwidth]{src/4/figures/cz_bandgap_v2.pdf}
  \caption{Bandgap characterization}
  \label{fig:bandgap-cz-v2}
\end{figure}

\begin{figure}[!h]
  \centering
  \includegraphics[width=0.4\textwidth]{src/4/figures/cz_reg_v2.pdf}
