...
\begin{figure}[!h]
  ...
  \caption{HMM pulse current waveform : 2 kV charging voltage on a 2\textOmega{} resistive load}
...
Overall, the generated waveform looks good on a 50 \textOmega{} load.
