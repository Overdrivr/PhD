...
The goal here is to identify functionnal failures and not hard-failures.
...
The disturbance of this signal could cause a propagation of issues way outside the integrated circuit, impacting other electronic modules and making some functionnalities temporarily unavailable.
