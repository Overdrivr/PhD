...
Figure. \ref{fig:near-field-current-sensor} show the principle of this sensor.
...
Finally, the sensed current is at the second level (pale blue).

%TODO: Use document Drive/These/07
...
This sensor requires specific post-processing to reconstitute the original current waveform.
The method is detailed in section \ref{sec:on-chip-near-field-process}.
